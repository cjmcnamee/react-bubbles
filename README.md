...
A token is used to authenticate a device so that it can use computer services

- [ ] What steps can you take in your web apps to keep your data secure?
You can make your web apps more secure by adding tokens and what-not to your code.

- [ ] Describe how web servers work.
When a computer is connected to the internet and wants to visit a website, the url link is translated into an ip address that is tracked down to a web server. once tracked down the web server sends the information back to your computer.
